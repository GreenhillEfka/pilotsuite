...
(async()=>{
 ...
 try{
  ...
  await page.waitForFunction(()=>document.getElementById('org-message').textContent.includes('Funktionszuordnung gespeichert')&&!window.PilotSuiteOrganization.dirty());
